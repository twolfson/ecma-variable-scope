...
function ecmaVariableScope(ast) {
  ...
  // TODO: With `with` noise, we can consider `lexicalScope`, `blockScope`, and `withScope` trees
  ...
  // Walk entire tree
    // If the item is a variable declaration
      ...
      // Lexical scopes
        // TODO: Cover `VariableDeclaration` -> `var name;`
      ...
      // Block scopes
        // TODO: Cover `BlockStatement` -> `{ let name; }`
      ...
      // Walk its declarators and save a reference to their declaration
        // DEV: This will probably only be shared by `let`, I am not sure all definitions have same way of referencing declarators
